            ...
            <div className="max-w-md w-full text-center space-y-8 backdrop-blur-sm bg-white/40 p-8 rounded-2xl shadow-xl border border-slate-200/50 dark:bg-slate-800/40 dark:border-slate-700/50">
                ...
                <div className="space-y-3">
                    ...
                    <p className="text-base text-slate-600 dark:text-slate-400">
                        Hold on there! You do not have the required permissions
                        to access this page. If you think this is a mistake,
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center pt-4">
                    ...
                    <button className="inline-flex items-center justify-center px-5 py-2.5 text-sm font-medium text-slate-700 bg-white hover:bg-slate-50 active:bg-slate-100 border border-slate-300 rounded-lg transition-colors duration-200 shadow-sm dark:bg-slate-800 dark:text-slate-200 dark:border-slate-600 dark:hover:bg-slate-700">
                        Go Back
                    </button>
                </div>
            </div>
